...
class AlgorithmPage(QWidget):
    def __init__(self, main_window):
        ...
        text = QLabel(
            ...
            "Для поперечных колебаний используется одна пользовательская модель с верифицированной первой собственной формой; "
            "результаты не требуют выбора между альтернативными режимами совместимости.<br><br>"
